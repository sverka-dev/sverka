...
- v1 feature coverage: caching, retries, suspend/resume, saga, MCP
  plugin transport (Spec 23), MCP server (Spec 28), agent steps,
  safe-outputs, network allowlist, run queries, all 6 targets
  (GitHub/GitLab/Drone + Temporal/Dagger/Inngest).

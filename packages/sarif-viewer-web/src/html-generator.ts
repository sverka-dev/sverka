// @sverka/sarif-viewer-web — pure HTML generation (browser-safe).
// No Node.js imports. Safe to import from browser code.
 ...
 *
 * Browser-safe: no Node.js imports. Safe to call from browser code.
 */
